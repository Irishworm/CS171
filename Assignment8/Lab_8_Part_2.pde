...
void setup()
{
  ...
  // create a triangle wave Oscil, set to 440 Hz, at 0.5 amplitude
...
void mouseMoved()
{
  float modulateAmount = map( abs(height-mouseY), 0, height, 0, 10 );
  float modulateFrequency = map( mouseX, 0, width, 1, 10 );
